      ...
      <div className="container px-6 py-8 mx-auto">
        <div className="text-center">
          ...
          <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
            ...
            <button className="w-full flex gap-2 px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
