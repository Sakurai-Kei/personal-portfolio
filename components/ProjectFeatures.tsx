...
import { ProjectFeaturesComponent } from "../interfaces/ProjectFeaturesComponent";

export default function ProjectFeatures(props: ProjectFeaturesComponent) {
  const { featuresDescription } = props;
  return (
    <section className="bg-white dark:bg-slate-800 overflow-x-hidden">
