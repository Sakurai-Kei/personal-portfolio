          ...
          <div className="bg-white px-4 dark:bg-gradient-to-r dark:from-slate-900 dark:via-slate-900 dark:to-pink-900 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
            ...
            <div className="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
              ...
              <div className="mt-8">
                <a
                  href="#"
                  className="px-5 py-2 font-semibold text-gray-100 transition-colors duration-200 transform bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-600 hover:to-blue-600 rounded-md hover:bg-gray-700"
                >
                  Check out Live!
                </a>
              </div>
